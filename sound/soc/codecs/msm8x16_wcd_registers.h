...
#if defined(CONFIG_MACH_GT5NOTE10_EUR_OPEN) // H/W request for Rx noise improve
#define MSM8X16_WCD_A_ANALOG_RX_HPH_BIAS_PA__POR		(0x5F)
#elif defined(CONFIG_MACH_GT5NOTE10_KOR_OPEN) // P555S h/w request
#define MSM8X16_WCD_A_ANALOG_RX_HPH_BIAS_PA__POR		(0x5F)
#else
