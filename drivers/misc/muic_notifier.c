...
void muic_notifier_attach_attached_dev(muic_attached_dev new_dev)
{
...
void muic_notifier_detach_attached_dev(muic_attached_dev cur_dev)
{
	printk(KERN_DEBUG "[muic] %s: (%d)\n", __func__, cur_dev);
...
void muic_notifier_logically_attach_attached_dev(muic_attached_dev new_dev)
{
	printk(KERN_DEBUG "[muic] %s: (%d)\n", __func__, new_dev);
...
void muic_notifier_logically_detach_attached_dev(muic_attached_dev cur_dev)
{
	printk(KERN_DEBUG "[muic] %s: (%d)\n", __func__, cur_dev);
