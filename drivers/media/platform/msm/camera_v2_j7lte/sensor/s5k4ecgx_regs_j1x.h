...
{0x0028, 0xD000,},
{0x002A, 0x007A,}, //config_clk_setting
{0x0F12, 0x0000,},
...
{0x002A, 0x163E,},
{0x0F12, 0x00C2,},	//af_search_usPeakThr 	//C0 -> A0 af_search_usPeakThr Full search (E5 90%)
{0x0F12, 0x0098,},	//af_search_usPeakThrLow  //80->98    //98(60%) -> CC(80%) SEHF_CHECK_IT
...
{0x002A, 0x15E8,},
{0x0F12, 0x0015,},   ////af_pos_usTableLastInd SEHF_CHECK_IT
{0x0F12, 0x0032,},   ////2A////32////32
{0x0F12, 0x0038,},   ////30////38////38
{0x0F12, 0x003E,},   ////36////3C////3E
{0x0F12, 0x0044,},   ////3C////40////44
{0x0F12, 0x004A,},   ////42////44////4A
{0x0F12, 0x0050,},   ////48////48////50
{0x0F12, 0x0056,},   ////4E////4C////56
{0x0F12, 0x005C,},   ////54////51////5C
{0x0F12, 0x0062,},   ////5A////56////62
{0x0F12, 0x0068,},   ////60////5C////68
{0x0F12, 0x006E,},   ////66////62////6E
{0x0F12, 0x0074,},   ////6C////68////74
{0x0F12, 0x007A,},   ////72////6E////7A
{0x0F12, 0x0080,},   ////78////74////80
{0x0F12, 0x0086,},   ////7E////7A////86
{0x0F12, 0x008C,},   ////84////81////8C
{0x0F12, 0x0092,},   ////8A////88////92
{0x0F12, 0x0098,},   ////90////90////98
{0x0F12, 0x009E,},   ////96////98////9E
{0x0F12, 0x00A4,},   ////9C////A0////A4
{0x0F12, 0x00AA,},   ////A2////A8////AA
{0x0F12, 0x00B0,},    ////A8////B0////B0
...
{0x0F12, 0x3141,}, //1820,	//70000A26//AFIT8_bnr_iDenThreshLow   [7:0] AFIT8_bnr_iDenThreshHigh
{0x0F12, 0x6024,},	//70000A28//AFIT8_ee_iLowSharpPower   [7:0] AFIT8_ee_iHighSharpPower
{0x0F12, 0x3140,}, //151B,	//70000A2A//AFIT8_ee_iLowShDenoise   [7:0] AFIT8_ee_iHighShDenoise
...
{0x0F12, 0x2832,}, //131C,	//70000ADC//AFIT8_bnr_iDenThreshLow   [7:0] AFIT8_bnr_iDenThreshHigh
{0x0F12, 0x6024,},	//70000ADE//AFIT8_ee_iLowSharpPower   [7:0] AFIT8_ee_iHighSharpPower
{0x0F12, 0x272C,}, //0F11,	//70000AE0//AFIT8_ee_iLowShDenoise   [7:0] AFIT8_ee_iHighShDenoise
...
{0x0F12, 0x2630,},     //0C15, 	//70000B92//AFIT8_bnr_iDenThreshLow   [7:0] AFIT8_bnr_iDenThreshHigh
{0x0F12, 0x6024,}, 	//70000B94//AFIT8_ee_iLowSharpPower   [7:0] AFIT8_ee_iHighSharpPower
{0x0F12, 0x1616,},     //0606, 	//70000B96//AFIT8_ee_iLowShDenoise   [7:0] AFIT8_ee_iHighShDenoise
...
{0x0F12, 0x232B,}, //090F,	//70000C48//AFIT8_bnr_iDenThreshLow   [7:0] AFIT8_bnr_iDenThreshHigh
{0x0F12, 0x6024,},	//70000C4A//AFIT8_ee_iLowSharpPower   [7:0] AFIT8_ee_iHighSharpPower
{0x0F12, 0x1414,}, //0505,	//70000C4C//AFIT8_ee_iLowShDenoise   [7:0] AFIT8_ee_iHighShDenoise
...
{0x0F12, 0x1114,}, //0407,	//70000CFE//AFIT8_bnr_iDenThreshLow   [7:0] AFIT8_bnr_iDenThreshHigh
{0x0F12, 0x6024,},	//70000D00//AFIT8_ee_iLowSharpPower   [7:0] AFIT8_ee_iHighSharpPower
{0x0F12, 0x1212,}, //0404,	//70000D02//AFIT8_ee_iLowShDenoise   [7:0] AFIT8_ee_iHighShDenoise
...
{0x0F12, 0x0A10,},	//0x0A00,},	//REG_0TC_CCFG_usWidth
{0x0F12, 0x078C,},	//0x0780,},	//REG_0TC_CCFG_usHeight
...
{0x0F12, 0x0001,},		/*REG_TC_GP_bUseReqInputInCap */
{0x002A, 0x02A6,},
{0x0F12, 0x0500,},	  //0280 /*REG_0TC_PCFG_usWidth */
{0x0F12, 0x03C0,},		//01E0 /*REG_0TC_PCFG_usHeight */
{0x002A, 0x02AB,},
...
{0x002A, 0x0250,},
{0x0F12, 0x0A10,},	//0x0A00,},	//REG_TC_GP_PrevReqInputWidth //2560
{0x0F12, 0x078C,},	//0x0780,},	//REG_TC_GP_PrevReqInputHeight //1920
{0x0F12, 0x0008,},	//0x0010,},	//REG_TC_GP_PrevInputWidthOfs //(2592-2576)/2
{0x0F12, 0x0006,},	//0x000C,},	//REG_TC_GP_PrevInputHeightOfs //(1944-1932)/2

{0x002A, 0x0262,},
{0x0F12, 0x0001,},	//REG_TC_GP_bUseReqInputInPre

{0x002A, 0x0494,},
{0x0F12, 0x0A10,},	//0x0A00,},	//REG_TC_PZOOM_PrevZoomReqInputWidth //2560
{0x0F12, 0x078C,},	//0x0780,},	//REG_TC_PZOOM_PrevZoomReqInputHeight //1920
...
{0x0F12, 0x0060,}, /*senHal_uAddColsBin */     
{0x0F12, 0x0060,}, /*senHal_uAddColsNoBin */   
{0x0F12, 0x0A20,},	//0x07DC,}, /*senHal_uMinColsBin */     
{0x0F12, 0x0AB0,},	//0x05C0,}, /*senHal_uMinColsNoBin */                 

{0x002A, 0x0250,},
{0x0F12, 0x0A10,},	//0x0A00,}, /*REG_TC_GP_PrevReqInputWidth //2560 */        
{0x0F12, 0x05A0,}, /*REG_TC_GP_PrevReqInputHeight //1536 */       
{0x0F12, 0x0008,},	//0x0010,}, /*REG_TC_GP_PrevInputWidthOfs //(2592-2560)/2*/
...
{0x0F12, 0x078C,},	//0x0780,}, //REG_TC_GP_PrevReqInputHeight //1920
{0x0F12, 0x0008,},	//0x0010,}, //REG_TC_GP_PrevInputWidthOfs //(2592-2560)/2
{0x0F12, 0x0006,},	//0x000C,}, //REG_TC_GP_PrevInputHeightOfs //(1944-1920)/2
