...
|| defined(CONFIG_MACH_J3LTE_SEA_XTC) || defined(CONFIG_MACH_J3LTE_SEA_XSA) || defined(CONFIG_MACH_J3XPROLTE_CHN_CTC)|| defined(CONFIG_MACH_J3XPROLTE_CHN_OPEN)) || defined(CONFIG_MACH_J3XPROLTE_CHN_CMCC)
	case MSM_CAMERA_LED_PREFLASH:
