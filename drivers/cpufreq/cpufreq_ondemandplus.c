...
#define DEFAULT_MAX_FREQ 1612800
static u64 allowed_max;

#define DEFAULT_INTER_HIFREQ 1209600
static u64 inter_hifreq;

#define DEFAULT_INTER_LOFREQ 400000
static u64 inter_lofreq;

#define SUSPEND_FREQ 200000
static u64 suspend_frequency;

#define DEFAULT_INTER_STAYCYCLES 2
static unsigned long inter_staycycles;

#define DEFAULT_STAYCYCLES_RESETFREQ 800000
...
static void cpufreq_ondemandplus_timer(unsigned long data)
{
        ...
        now_idle = _get_cpu_idle_time(data, &pcpu->timer_run_time);
        smp_wmb();
...
rearm:
        if (!timer_pending(&pcpu->cpu_timer)) {
                ...
                pcpu->time_in_idle = _get_cpu_idle_time(
