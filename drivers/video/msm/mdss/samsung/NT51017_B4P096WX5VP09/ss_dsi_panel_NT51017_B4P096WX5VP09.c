 ...
 *
*/
#include "ss_dsi_panel_NT51017_B4P096WX5VP09.h"
#include "ss_dsi_mdnie_NT51017_B4P096WX5VP09.h"
...
static void mdss_panel_tft_pwm_control(struct mdss_dsi_ctrl_pdata *ctrl, int bl_lvl)
{
	...
	if(ctrl->panel_data.panel_info.blank_state == MDSS_PANEL_BLANK_UNBLANK) {
		...
		vdd->panel_func.samsung_bl_ic_i2c_ctrl(vdd->scaled_level);
	}
}
...
static void mdss_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->support_panel_max = NT51017_B4P096WX5VP09_SUPPORT_PANEL_COUNT;
