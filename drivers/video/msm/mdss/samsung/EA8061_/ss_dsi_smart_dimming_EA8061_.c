 ...
 *
*/
#include "ss_dsi_smart_dimming_EA8061_.h"
...
{
	return gradation_offset_revB[table_index][index];
}

static int get_rgb_offset(int table_index, int index)
{
		return rgb_offset_revB[table_index][index];
}
...
struct smartdim_conf *smart_get_conf_EA8061_(void) {
