 ...
 *
*/
#include "ss_dsi_panel_EA8061_.h"
#include "ss_dsi_mdnie_EA8061_.h"
...
#endif
static int mdss_smart_dimming_init_EA8061(struct mdss_dsi_ctrl_pdata *ctrl)
{
	struct samsung_display_driver_data *vdd = check_valid_ctrl(ctrl);
	...
	if (IS_ERR_OR_NULL(vdd->smart_dimming_dsi[ctrl->ndx])) {
		...
		mdss_samsung_panel_data_read(ctrl,
			...
			vdd->smart_dimming_dsi[ctrl->ndx]->mtp_buffer, PANEL_MTP_READ);
...
static void mdss_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_mdnie_read = NULL;//mdss_mdnie_read;
	vdd->panel_func.samsung_smart_dimming_init = NULL;
	vdd->panel_func.samsung_smart_dimming_init_EA8061 = mdss_smart_dimming_init_EA8061;
