 ...
 *
*/
#include "ss_dsi_panel_S6E8AA5X01_AMS497HY01.h"
#include "ss_dsi_mdnie_S6E8AA5X01_AMS497HY01.h"
...
static char coordinate_data[][COORDINATE_DATA_SIZE] = {
	...
	{0xf8, 0x00, 0xf5, 0x00, 0xff, 0x00}, /* Tune_3 */
	{0xff, 0x00, 0xfd, 0x00, 0xfa, 0x00}, /* Tune_4 */
	{0xff, 0x00, 0xff, 0x00, 0xff, 0x00}, /* Tune_5 */
	{0xf9, 0x00, 0xfa, 0x00, 0xff, 0x00}, /* Tune_6 */
...
static void mdss_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->panel_func.samsung_smart_get_conf = smart_get_conf_S6E8AA5X01_AMS497HY01;
...
static int __init samsung_panel_init(void)
{
	...
	if (!strncmp(vdd->panel_name, old_panel_string, strlen(old_panel_string)))
		...
		strncpy(vdd->panel_name, old_panel_string, strlen(old_panel_string)+1);
