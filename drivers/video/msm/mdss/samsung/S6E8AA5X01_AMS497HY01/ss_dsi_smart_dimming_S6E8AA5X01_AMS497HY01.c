 ...
 *
*/
#include "ss_dsi_smart_dimming_S6E8AA5X01_AMS497HY01.h"
	...
	*index = -1;
	...
	for (cnt = 0; cnt < (GRAY_SCALE_MAX - 1); cnt++) {
		if (gamma_curve == GAMMA_CURVE_1P9) {
			...
			delta_1 = candela - curve_2p0_360[cnt];
			delta_2 = candela - curve_2p0_360[cnt + 1];
		} else {
			delta_1 = candela - curve_2p2_360[cnt];
			delta_2 = candela - curve_2p2_360[cnt + 1];
		}
...
struct smartdim_conf *smart_get_conf_S6E8AA5X01_AMS497HY01(void) {
