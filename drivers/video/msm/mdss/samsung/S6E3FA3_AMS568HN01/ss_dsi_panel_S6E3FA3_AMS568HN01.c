...
static struct dsi_panel_cmds * mdss_elvss_temperature2(struct mdss_dsi_ctrl_pdata *ctrl, int *level_key)
{
	...
	if (vdd->temperature > 0)
		...
		if (candela_value >= 2 && candela_value <= 11) /* 2 ~ 11 nit */
			vdd->dtsi_data[ctrl->ndx].elvss_lowtemp2_tx_cmds[vdd->panel_revision].cmds[1].payload[1]
			= 0x18;
		else if (candela_value >= 12 && candela_value <= 15) /* 12 ~ 15 nit */
			vdd->dtsi_data[ctrl->ndx].elvss_lowtemp2_tx_cmds[vdd->panel_revision].cmds[1].payload[1]
			= vdd->display_ststus_dsi[ctrl->ndx].elvss_value + 0x09;
		else if (candela_value == 16) /* 16 nit */
			vdd->dtsi_data[ctrl->ndx].elvss_lowtemp2_tx_cmds[vdd->panel_revision].cmds[1].payload[1]
			= vdd->display_ststus_dsi[ctrl->ndx].elvss_value + 0x07;
		else if (candela_value == 17) /* 17 nit */
			vdd->dtsi_data[ctrl->ndx].elvss_lowtemp2_tx_cmds[vdd->panel_revision].cmds[1].payload[1]
			= vdd->display_ststus_dsi[ctrl->ndx].elvss_value + 0x05;
		else if (candela_value <= 19) /* 19 nit */
			vdd->dtsi_data[ctrl->ndx].elvss_lowtemp2_tx_cmds[vdd->panel_revision].cmds[1].payload[1]
		...
		if (candela_value >= 2 && candela_value <= 11) /* 2 ~ 11 nit */
			...
			vdd->dtsi_data[ctrl->ndx].elvss_lowtemp2_tx_cmds[vdd->panel_revision].cmds[1].payload[1]
			= vdd->display_ststus_dsi[ctrl->ndx].elvss_value + 0x08;
		else if (candela_value == 16) /* 16 nit */
			vdd->dtsi_data[ctrl->ndx].elvss_lowtemp2_tx_cmds[vdd->panel_revision].cmds[1].payload[1]
			= vdd->display_ststus_dsi[ctrl->ndx].elvss_value + 0x06;
		else if (candela_value == 17) /* 17 nit */
			vdd->dtsi_data[ctrl->ndx].elvss_lowtemp2_tx_cmds[vdd->panel_revision].cmds[1].payload[1]
