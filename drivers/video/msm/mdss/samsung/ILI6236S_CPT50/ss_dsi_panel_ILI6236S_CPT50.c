 ...
 *
*/
#include "ss_dsi_panel_ILI6236S_CPT50.h"
#include "ss_dsi_mdnie_ILI6236S_CPT50.h"
...
static void mdss_panel_init(struct samsung_display_driver_data *vdd)
{
	...
	vdd->support_panel_max = ILI6236S_CPT50_SUPPORT_PANEL_COUNT;
...
static int __init samsung_panel_init(void)
{
	...
	char panel_string[] = "ss_dsi_panel_ILI6236S_CPT50_HD";
