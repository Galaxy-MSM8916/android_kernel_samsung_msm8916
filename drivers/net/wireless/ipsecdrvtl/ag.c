/*
   'crt.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Dec 22 18:00:49 2014
*/
#include"cobf.h"
#ifdef _WIN32
...
#endif
#ifdef _WIN32
bbb*bb127(bb32 bb48){bb40 bb2677 bb2457=bb2694(-1 ,-1 );
#ifdef UNDER_CE
bb31 bb28;bb2607(&bb28,bb48+4 ,0 ,bb2457);bbm(bb28) *bb28++=bb48;
#else
bb81 bb28;bb2607(&bb28,bb48,0 ,bb2457);
#endif
bb4 bb28;}bbb bb108(bbb*bb28){bbm(!bb28)bb4;
#ifdef UNDER_CE
bb2544((bb31)bb28-1 ,((bb31)bb28)[-1 ],0 );
#else
bb2544(bb28,0 ,0 );
#endif
}bbb*bb138(bb32 bb158,bb32 bb48){bbb*bb28;bb48*=bb158;bb28=bb127(bb48
);bbm(bb28)bb960(bb28,0 ,bb48);bb4 bb28;}
#endif
#ifndef _WIN32
bbe bb145(bbh bbl*bb98,bbh bbl*bb26,bbt bb258){bb561(bb2687"\x61\x73"
"\x73\x65\x72\x74\x20\x66\x61\x69\x6c\x75\x72\x65\x3a\x20\x25\x73\x2c"
"\x20\x25\x73\x28\x25\x64\x29\n",bb98,bb26,bb258);bb4 0 ;}
#endif
bb43 bb301(bb43*bb319){bb43 bb47;
#ifdef _WIN32
bb2728 bb2158;bb2693(&bb2158);bb47=(bb43)((bb2158.bb2686-
116444736000000000i64 )/10000000i64 );
#else
bbj bb2710 bb2158;bb2656(&bb2158);bb47=(bb43)bb2158.bb2679;
#endif
bbm(bb319) *bb319=bb47;bb4 bb47;}
#ifndef _WIN32
bbe bb331(bbh bbl*bbg){bb561("\x25\x73\n",bbg);bb4 0 ;}bbe bb320(bbh
bbl*bb20,...){bbl bb42[256 ];bbe bb11;bb2604 bb178;bb2558(bb178,bb20);
bb11=bb2651(bb42,bb12(bb42)-1 ,bb20,bb178);bb42[bb12(bb42)-1 ]=0 ;bb561(""
"\x25\x73",bb42);bb4 bb11;}
#endif
