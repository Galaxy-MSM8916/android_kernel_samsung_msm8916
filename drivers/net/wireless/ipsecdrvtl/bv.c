/*
   'src_pm_pgpNetPMConfig.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Dec 22 18:00:49 2014
*/
#include"cobf.h"
#ifdef _WIN32
...
bb2090(bb35*bbi);bb7 bb1815(bb35*bbi,bb503*bb471){bbm(!bbi->bb471){
bbi->bb471=bb127(bb12( *bb471));bbm(!bbi->bb471)bb4 bb365;}bb74(bbi->
bb471,bb471,bb12( *bb471));bb4 bb101;}bbb bb2090(bb35*bbi){bbm(bbi->
bb471)bb108(bbi->bb471);bbi->bb471=bb93;}
