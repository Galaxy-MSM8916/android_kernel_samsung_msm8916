/*
   'src_compress_deflate_infutil.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Dec 22 18:00:49 2014
*/
#include"cobf.h"
#ifdef _WIN32
...
{bbe bb460;};bbj bb1329{bbe bb460;};bbe bb411(bbg,bb0,bb24)bb308*bbg;
bb16 bb0;bbe bb24;{bb9 bb11;bb34*bb28;bb34*bb87;bb28=bb0->bb619;bb87=
bbg->bb378;bb11=(bb9)((bb87<=bbg->bb199?bbg->bb199:bbg->bb456)-bb87);
bbm(bb11>bb0->bb397)bb11=bb0->bb397;bbm(bb11&&bb24==(-5 ))bb24=0 ;bb0->
bb397-=bb11;bb0->bb642+=bb11;bbm(bbg->bb1582!=0 )bb0->bb377=bbg->bb502
=( *bbg->bb1582)(bbg->bb502,bb87,bb11);bb74(bb28,bb87,bb11);bb28+=
bb11;bb87+=bb11;bbm(bb87==bbg->bb456){bb87=bbg->bb159;bbm(bbg->bb199
==bbg->bb456)bbg->bb199=bbg->bb159;bb11=(bb9)(bbg->bb199-bb87);bbm(
bb11>bb0->bb397)bb11=bb0->bb397;bbm(bb11&&bb24==(-5 ))bb24=0 ;bb0->
bb397-=bb11;bb0->bb642+=bb11;bbm(bbg->bb1582!=0 )bb0->bb377=bbg->bb502
=( *bbg->bb1582)(bbg->bb502,bb87,bb11);bb74(bb28,bb87,bb11);bb28+=
bb11;bb87+=bb11;}bb0->bb619=bb28;bbg->bb378=bb87;bb4 bb24;}
