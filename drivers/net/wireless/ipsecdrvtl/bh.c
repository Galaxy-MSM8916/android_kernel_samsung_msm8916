/*
   'src_ipsec_pgpIPheader.c' Obfuscated by COBF (Version 1.06 2006-01-07 by BB) at Mon Dec 22 18:00:49 2014
*/
#include"cobf.h"
#ifdef _WIN32
...
bbb bb1016(bby*bb53);bbu bb1051(bbf*bb53);bb13{bb1163=-5000 ,bb1143=-
4000 ,bb1032=-4999 ,bb1062=-4998 ,bb1050=-4997 ,bb1015=-4996 ,bb1184=-4995
,bb1120=-4994 ,bb1140=-4993 ,bb1052=-4992 ,bb1125=-4991 };bb7 bb1164(bb7
bb1161,bbd bb1152,bbl*bb1136);bba bb13{bb423,bb1524,}bb306;bbk bb1235
(bb306 bb881,bbh bbf*bb464);bbd bb553(bb306 bb881,bbh bbf*bb464);bbb
bb1213(bbk bb158,bb306 bb584,bbf bb452[2 ]);bbb bb1006(bbd bb158,bb306
bb584,bbf bb452[4 ]);bbk bb942(bbh bbb*bb1892){bb59 bb304=(bb59)bb1892
;bbd bb605=0 ;bbk bbz=0 ;bb109(bbz++<(bb12(bb330)/2 )){bb605+= *bb304++;
}bb605=(bb605>>16 )+(bb605&0xffff );bb605+=(bb605>>16 );bb605=~bb605;bb4
(bbk)bb605;}bbk bb660(bbh bbb*bb528,bbe bb22){bb59 bb446=(bb59)bb528;
bbd bb605=0 ;bb109(bb22>1 ){bb605+= *bb446++;bbm(bb605&0x80000000 )bb605
=(bb605&0xffff )+(bb605>>16 );bb22-=2 ;}bbm(bb22)bb605+= * (bb3)bb446;
bb109(bb605>>16 )bb605=(bb605&0xffff )+(bb605>>16 );bb605=~bb605;bb4(bbk
)bb605;}bb7 bb614(bby*bb88,bbf bb104,bby*bb60){bbd bb1132;bb7 bb18;
bb1132=bb536(bb88);bb18=bb489(bb88,0 ,bb60,0 ,bb1132);bbm(((bb18)==
bb101))bb60->bb76[9 ]=bb104;bb4 bb18;}bb7 bb654(bby*bb88,bbu bb179,bbf
 *bb419){bb7 bb18=bb101;bbm(bb179) *bb419=4 ;bb50*bb419=bb88->bb76[9 ];
bb4 bb18;}bb7 bb982(bby*bb60,bbf*bb399){bbd bb1132;bbd bb163;bbd
bb2199;bb7 bb18=bb101;bb1132=bb536(bb60);bb74(bb399,bb60->bb76,bb1132
);bb60->bb76[1 ]=0 ;bb60->bb76[6 ]=0 ;bb60->bb76[6 +1 ]=0 ;bb60->bb76[8 ]=0 ;
bb60->bb76[10 ]=0 ;bb60->bb76[10 +1 ]=0 ;bbm(bb1132==20 )bb4 bb18;bb163=20 ;
bb109(bb60->bb76[bb163]!=0 ){bb338(bb60->bb76[bb163]){bb17 1 :bb163++;
bb21;bb17 130 :bb17 133 :bb17 134 :bb17 148 :bb17 149 :bb163++;bb163+=bb60
->bb76[bb163]+1 ;bb21;bb477:bb60->bb76[bb163]=0 ;bb2199=bb163+1 ;bb163+=
2 ;bb90(;bb163<=(bb2199+bb60->bb76[bb2199]);bb163++)bb60->bb76[bb163]=
0 ;bb60->bb76[bb2199]=0 ;bb21;}}bb4 bb18;}bb7 bb962(bbh bbf*bb399,bby*
bb60){bbd bb1132;bb7 bb18=bb101;bb1132=bb536(bb60);bb74(bb60->bb76,
bb399,bb1132);bb4 bb18;}bb7 bb564(bby*bb53,bbf bb104,bbd*bb968){bb7
bb18=bb101; *bb968=0 ;bbm(bb53->bb76[9 ]!=bb104)bb4 bb1015; *bb968=
bb536(bb53);bb4 bb18;}bb7 bb946(bby*bb88,bbf bb104,bbf bb419,bby*bb60
){bbd bb1132;bb7 bb18;bbm(bb88->bb76[9 ]!=bb104)bb4 bb1015;bb1132=
bb536(bb88);bb18=bb489(bb88,0 ,bb60,0 ,bb1132);bbm(((bb18)==bb101))bb60
->bb76[9 ]=bb419;bb4 bb18;}bbd bb536(bby*bb53){bb4(bb53->bb76[0 ]&0x0F ) *
4 ;}bbk bb554(bby*bb53){bb4 bb1235(bb423,&bb53->bb76[2 ]);}bbb bb549(
bbk bb152,bby*bb53){bb1213(bb152,bb423,&bb53->bb76[2 ]);}bbb bb556(bby
 *bb53){bbd bb157;bbk bb326;bbd bbz;bbd bb1132;bb157=0 ;bb1132=bb536(
bb53);bb53->bb76[10 ]=0 ;bb53->bb76[10 +1 ]=0 ;bb90(bbz=0 ;bbz<bb1132;bbz+=
2 ){bb157+=(bb53->bb76[bbz]<<8 )|(bb53->bb76[bbz+1 ]);}bb326=~((bbk)bb157
+(bbk)(bb157>>16 ));bb1213(bb326,bb423,&bb53->bb76[10 ]);}bbb bb1009(
bby*bb53,bbd*bb29){bb74(bb29,&bb53->bb76[12 ],4 );}bbb bb1035(bby*bb53,
bbd*bb29){bb74(bb29,&bb53->bb76[16 ],4 );}bbb bb1060(bby*bb53,bbd bb29){
bb74(&bb53->bb76[12 ],&bb29,4 );}bbb bb954(bby*bb53,bbd bb29){bb74(&
bb53->bb76[16 ],&bb29,4 );}bbb bb1016(bby*bb53){bb53->bb76[6 ]&=0xBF ;}
bbu bb1051(bbf*bb53){bbm(bb53[6 ]&0x20 )bb4 1 ;bb50{bbm((bb53[6 ]&0x1F )||
