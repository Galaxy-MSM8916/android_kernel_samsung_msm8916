...
#define SAMSUNG_TSP_INFO				1
#define SAMSUNG_PALM_MOTION				0
#define SAMSUNG_TOUCH_MODE				1
#define CYTTSP5_USE_SLEEP 				0
#define CYTTSP5_REPORT_DATA_FROM_TABLE			1

#ifdef VERBOSE_DEBUG
#define VERBOSE_DEBUG_CYTTSP				1
#else
#define VERBOSE_DEBUG_CYTTSP				0
#endif

#define TEMP_BLOCK_FOR_BRINGUP

#define CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP5_MT_B		1
#define CYTTSP5_TOUCHLOG_ENABLE 			0
#define FORCE_SATISFY_PALMPAUSE_FOR_LARGEOBJ		0

#define	ENABLE_BTN_PROBE				0
#define ENABLE_PROXIMITY_PROBE				0
#define ENABLE_SAMSUNG_FACTORY_PROBE			1
#define ENABLE_DEVICE_ACCESS_PROBE			1
#define ENABLE_DEBUG_PROBE				0
...
#define CY_HID_OUTPUT_BL_INITIATE_BL_TIMEOUT	16000
...
enum hid_output_bl {
	...
	HID_OUTPUT_BL_LAUNCH_APP_FAST = 0x3A,
...
#if TTHE_TUNER_SUPPORT || SAMSUNG_FACTORY_TEST
