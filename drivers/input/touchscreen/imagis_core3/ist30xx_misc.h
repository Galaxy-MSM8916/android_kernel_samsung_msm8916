...
#define IST30XX_CHKIC_LOAD_END          (0x8FFFFCAB)
#define IST30XX_CHKIC_END                       (0x8FAB0FAB)

#define IST30XX_CHECKSUM_SIZE           (4)
#define IST30XX_CHKIC_OK                        (0x00000001)
#define IST30XX_CHKIC_FAIL                      (0x000000FF)

#define IST30XX_CHKIC_WAIT                      (30)    // 3.0sec
