 ...
 */
extern void muic_notifier_attach_attached_dev(muic_attached_dev new_dev);
extern void muic_notifier_detach_attached_dev(muic_attached_dev cur_dev);
extern void muic_notifier_logically_attach_attached_dev(muic_attached_dev new_dev);
extern void muic_notifier_logically_detach_attached_dev(muic_attached_dev cur_dev);
